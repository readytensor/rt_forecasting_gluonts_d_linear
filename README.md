# DLinear Forecaster in GluonTS

DLinear Forecaster for the Forecasting problem category as per Ready Tensor specifications.
...
- A **DLinear Forecaster** algorithm built using **GluonTS**
